...
require.def("mpc/settings",
  function() {
    ...
    var SettingsKey = "node-mpc.settings";
    ...
    function init() {
      ...
      if(window.localStorage) {
        var val = window.localStorage[SettingsKey];
        if(val) {
    ...
    return {
      ...
      namespaces: function () {
        var namespaces = Object.keys(defaultSettings).map(function (name) {
